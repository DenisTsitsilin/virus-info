    ...
    public MainInfo getMainInfo(){
        ...
        try {
            ...
            for (Element td : tds) {
                ...
                mainInfo.setHealedPlus(h3.get(0).getElementsByTag("sup").text().replaceAll(" ", "").replaceAll("[+]", ""));
                mainInfo.setHealed(h3.get(0).text().replaceAll(" ", "").replaceAll("[+]", "").replaceAll(mainInfo.getHealedPlus(),""));
                mainInfo.setStickPlus(h3.get(1).getElementsByTag("sup").text().replaceAll(" ", "").replaceAll("[+]", ""));
                mainInfo.setStick(h3.get(1).text().replaceAll(" ", "").replaceAll("[+]", "").replaceAll(mainInfo.getStickPlus(),""));
